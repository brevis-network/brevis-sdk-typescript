...
export class ExtensionRangeOptionsDeclaration extends pb_1.Message {
    ...
    constructor(data?: any[] | {
        ...
        if (!Array.isArray(data) && typeof data == "object") {
            ...
            if ("is_repeated" in data && data.is_repeated != undefined) {
                this.is_repeated = data.is_repeated;
            }
    ...
    static fromObject(data: {
        ...
        if (data.is_repeated != null) {
            message.is_repeated = data.is_repeated;
        }
    ...
    toObject() {
        ...
        if (this.is_repeated != null) {
            data.is_repeated = this.is_repeated;
        }
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.has_is_repeated)
            writer.writeBool(4, this.is_repeated);
        ...
        while (reader.nextField()) {
            ...
            switch (reader.getFieldNumber()) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    message.is_repeated = reader.readBool();
                    break;
                case 5:
    ...
    static deserializeBinary(bytes: Uint8Array): ExtensionRangeOptionsDeclaration {
...
export class FieldOptions extends pb_1.Message {
    ...
    constructor(data?: any[] | {
        ...
        super();
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [19, 999], this.#one_of_decls);
        if (!Array.isArray(data) && typeof data == "object") {
